...
$NIKK = $_SESSION['NIK'];
$query = mysqli_query($con,"SELECT * FROM myktpk WHERE NIK='".$NIKK."'") or die(mysql_error());   //melakukan query pada database
$data = mysqli_fetch_array($query);
$NIK = $data['NIK'];
$waktu_ktp = $data['waktu_ktp'];
/**
...
$pdf->SetX(100);
$pdf->Cell(60,8,'NIK',1,0,'C',1);
$pdf->SetX(160);
$pdf->Cell(60,8,'Waktu Pengisian',1,0,'C',1);
$pdf->SetX(30);
$pdf->Ln();
...
$pdf->SetX(100);
$pdf->MultiCell(60,8,$NIK,1,'C');

$pdf->SetY($Y_Table_Position);
$pdf->SetX(160);
$pdf->MultiCell(60,8,$waktu_ktp,1,'L');
